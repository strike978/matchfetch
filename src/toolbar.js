;(function () {
    ...
    style.textContent = [
        ...
        '.service-opt:not(.active):hover { background: #253044; color: #e2e8f0; }'
    ].join('')
    document.head.appendChild(style)

    var isAncestry = /\/ancestry\//.test(location.pathname)
    var is23 = /\/23andme\//.test(location.pathname)
