;(function () {
    ...
    bar.innerHTML = '<a class="topbar-home" href="javascript:;"><div class="topbar-icon"><img src="../icons/icon32.png" width="28" height="28" alt="M"></div>'
    ...
    ;['githubBtn','discordBtn','supportBtn'].forEach(function(id) {
        var el = document.getElementById(id)
        if (!el) return
        if (id === 'githubBtn') el.addEventListener('click', function() { chrome.tabs.create({ url: 'https://github.com/strike978/matchfetch_ext' }) })
        else if (id === 'discordBtn') el.addEventListener('click', function() { chrome.tabs.create({ url: 'https://discord.com/invite/f5BtHTM2zZ' }) })
